#' Dataset with the lat. / long. of county FIPS codes used for mapping state-level data to a Lambert projection.
#'
#' To access the data directly, issue the command \code{state_map_data)}.
#' 
